...
.then(async () => {
    ...
    const cars = [
        ...
        // =========================
        {
            ...
            type: "SUV",
            priceRange: "₹7.5L - ₹13L",
            engineOptions: ["1.2L Petrol", "1.0L Turbo"],
            mileage: "20-22 kmpl",
            fuelType: ["Petrol", "CNG"],
            transmission: ["Manual", "AMT"],
            seatingCapacity: 5,
            images: ["fronx/fronx-exterior-1.jpg"]
        },
        {
            brand: "Maruti Suzuki",
            model: "Brezza",
            ...
            seatingCapacity: 5,
            images: ["brezza/brezza-exterior-1.jpg"]
        },
        {
            brand: "Maruti Suzuki",
            model: "Grand Vitara",
